...
def turn():
    ...
    if trade1 == True or trade2 == True:
        ...
        wealth =  wealth + 3 * len(provincesClaimed['playername']) * morale/100 *1.5
        ...
        wealth =  wealth + 3 * len(provincesClaimed['playername']) * morale/100 *2
    else:
        wealth =  wealth + 3 * len(provincesClaimed['playername']) * morale/100 *1.5
...
b = 'Your son murdered one of your citizens. People are demanding an execution. Do you respect their wishes?'
